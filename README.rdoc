...
As i became more confortable with rails and learn new techniques i made sure that i used them to this new version of this app. Also,
it is fun cleaning messy codes :)
...
* Gem used: foundation, jquery-rails, aws-sdk, paperclip, font-awesome-rails, devise
