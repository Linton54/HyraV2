...
* Send Messages to other users (users must reload the page to view the image, reason why i learn React.JS)
...
* Gem used: foundation, jquery-rails, aws-sdk, paperclip, font-awesome-rails, devise, bullet
